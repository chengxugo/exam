package com.chengxugo.mapper.exam;
...
public interface ExamMapper {
    ...
    List<PaperChoice> RandChoice(@Param("choicenum")Long choicenum, @Param("chaptertwo")Long chaptertwo, @Param("difficulty")int difficulty);
    List<PaperJudge> RandJudge(@Param("judgenum")Long judgenum, @Param("chaptertwo") Long chaptertwo, @Param("difficulty")int difficulty);
