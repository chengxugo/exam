...
import com.chengxugo.mapper.exam.ExamMapper;
...
public class ExamServiceImpl implements ExamService {
    ...
    @Override
    public List<PaperChoice> RandChoice(Long choicenum, Long chaptertwo, int difficulty) {
        return examMapper.RandChoice(choicenum,chaptertwo,difficulty);
    }

    @Override
    public List<PaperJudge> RandJudge(Long judgenum, Long chaptertwo, int difficulty) {
