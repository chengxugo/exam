...
<div class="wrapper" class="center-in-center">
    <form  method="post" id = "downloadDocId"  class="main" >
        <table>
            <div class="loginBox" >
                <div class="loginBoxCenter">
                    <h2 class="card-title" style="align-content: center">在线考试系统</h2>
                    <p><label for="username">用户姓名：</label></p>
