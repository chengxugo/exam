...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <table border="1" class="table table-bordered" id = "tab1">
            ...
            <tr>
                <th>专业</th>
                <th>操作&nbsp;<input id="addmajor" style="width:20%" class="btn btn-outline btn-primary" type="button" value="添加"  data-toggle="modal">
                </th>
            </tr>
    ...
    <!-- 添加小节的模态框 -->
    <div class="modal fade" id="addma" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="my">添加专业</h4>
                </div>
                <form class="form-horizontal" action="<%=basePath%>/basic/insertma.do" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">学年</label>
                            <div class="col-sm-10">
                                <select class="form-control" id="masters" name = "seid"></select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">专业</label>
                            <div class="col-sm-10">
                                <input type="text" name="maname" class="form-control"  placeholder="">
...
<script>
    ...
    function getmaster() {
        $.ajax({
            ...
            success:function(data) {
                var aa =$(document).find("#masters");
                console.log("删除的班级");
                for (var i = 0; i < data.length; i++) {
                    aa.append("<option value='" + data[i].seid + "'>" + data[i].sename + "</option>");
                }
            }
        });
    }
    ...
    function deletemajor(maid) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (0 != data.length){
                    alert("请先删除此专业下的所有班级"+data.length);
                }
                else {
                    $.ajax({
