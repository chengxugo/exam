...
<script>
    ...
    $("#teacheradd").click(function () {
        ...
        $.ajax({
            url: '<%=basePath%>/basic/findmajorall.do',
            type: 'POST',
            success: function (data) {
                for (var i = 0; i < data.length; i++) {
                    $("#major").append("<option value='" + data[i].maname + "'>" + data[i].maname + "</option>");
                }
            }
        });
        $("#tchadd").modal({
    ...
    function edit(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                for (var i = 0; i < data.length; i++) {
                    $("#upmajor").append("<option value='" + data[i].maname + "'>" + data[i].maname + "</option>");
                }
            }
        });
        if (!id) {
