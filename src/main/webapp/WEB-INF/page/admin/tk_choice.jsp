...
<script type="text/javascript">
    $(function(){
        ...
        $('#getAllSelectedId').click(function(){
            ...
            location.href = "<%=basePath%>/tk/deletemanychoice.do?chk_value="+chk_value;
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<%=basePath%>/tk/allchoice.do">选择题查询</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<%=basePath%>/user/findstuscore.do">学生成绩查询</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<%=basePath%>/basic/allsemester.do">学年信息</a>
                            </li>
                            <li>
                                <a href="<%=basePath%>/basic/allsit.do">职称信息</a>
                            </li>
                            <li>
                                <a href="<%=basePath%>/basic/allmajor.do">专业信息</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="<%=basePath%>/tk/allchoice.do?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li><a href="<%=basePath%>/tk/allchoice.do?pn=${pageInfo.pageNum-1}"
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li><a href="<%=basePath%>/tk/allchoice.do?pn=${page_Num }">${page_Num }</a></li>
                            </c:if>
                        ...
                        <li><a href="<%=basePath%>/tk/allchoice.do?pn=${pageInfo.pages}">末页</a></li>
                    </ul>
                </nav>
            </div>
        </div>
        ...
        <div class="modal fade" id="editch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<%=basePath%>/tk/upchoice.do" method="post">
        ...
        <div class="modal fade" id="addch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<%=basePath%>/tk/createchoice.do" method="post">
                        <div class="modal-body">
                            <input name="id" id="id" hidden="hidden"/>
                            <div class="form-group input-group">
                                <span class="input-group-addon" style="height: 40px ; tab-size: 16px ">题目：</span>
    ...
    function getpt() {
        ...
        $.ajax({
            ...
            success:function (data){
                ...
                for(var i = 0; i < data.length; i++){
                    upchapter.append("<option value='" + i + "'>" + data[i].pointname + "</option>");
                }for(var j = 0; j < data[0].point2.length; j++) {
                    upchaptertwo.append("<option value='" + data[0].point2[j].bid + "'>" + data[0].point2[j].pname + "</option>");
                }
                //select1绑定change事件
                $("#upchapter").change(function () {
                    ...
                    $("#upchaptertwo").empty();
                    for (var j = 0; j < data[p].point2.length; j++) {
                        upchaptertwo.append("<option value='" + data[p].point2[j].bid+ "'>" + data[p].point2[j].pname+ "</option>");
                    }
                });
            }
        })
    ...
    function trash(id) {
        if (!id) {
            ...
            $(".delSure").click(function () {
                $.ajax({
                    url: '<%=basePath%>/tk/deletechoice.do?id=' + id,
                    type: 'POST',
                    success: function (data) {
                        $("body").html(data);
                    }
