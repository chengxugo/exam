...
--%>
    ...
    <script language="javascript" type="text/javascript" src="<%=basePath%>/bootstrap/js/bootstrap.js"></script>
                ...
                <form class="form-horizontal" role="form" id="examPaperAction" action="<%=basePath%>/exam/examadd.do" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select class="form-control" name="chaptertwo" id="chaptertwo" data-live-search="true" multiple>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div style="text-align: left">
                            <input type="date" value="2020-06-18" name="begindate"/>至
                            <input type="date" value="2020-06-18" name="enddate"/>
                        </div>
                    </div>
                    <div class="form-group">
