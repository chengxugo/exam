        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="<%=basePath%>/tk/allchoice1.do?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li><a href="<%=basePath%>/tk/allchoice1.do?pn=${pageInfo.pageNum-1}"
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li><a href="<%=basePath%>/tk/allchoice1.do?pn=${page_Num }">${page_Num }</a></li>
                            </c:if>
                        ...
                        <li><a href="<%=basePath%>/tk/allchoice1.do?pn=${pageInfo.pages}">末页</a></li>
                    </ul>
                </nav>
            </div>
        </div>
        ...
        <div class="modal fade" id="addch" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<%=basePath%>/tk/createchoice1.do" method="post">
                        <div class="modal-body">
    ...
    function trash(id) {
        if (!id) {
            ...
            $(".delSure").click(function () {
                $.ajax({
                    url: '<%=basePath%>/tk/deletechoice1.do?id=' + id,
                    type: 'POST',
                    success: function (data) {
                        $("body").html(data);
                    }
